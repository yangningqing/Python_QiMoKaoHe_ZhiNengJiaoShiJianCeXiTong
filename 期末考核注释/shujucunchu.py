...
def append_environment_record(csv_path: str, room: str, timestamp: str,
                              data: Dict[str, float], controls: Dict[str, str]) -> None:
    """将监测数据追加写入 CSV 文件。"""
...
def append_sign_record(csv_path: str, student_name: str, source: str = "二维码") -> None:
    """记录学生签到信息。"""
    file_exists = os.path.exists(csv_path)
    row = [
...
def load_sign_names(csv_path: str) -> List[str]:
    """
    ...
    return records
def clear_sign_records(csv_path: str) -> None:
